...
CHECKPOINTS=log
R=.pth.tar
LOG_NAME=product_ms_bs128_lossNo
LOADER_TYPE=multi_repeat
LOSS_BALANCE=False
RESUME=/home/nfs/admin0/yaoguang/code/MetricLearning/Object-retrieval-others/log/Weight/product/checkpoints/product_ms_bs128_lossNo/model_best.pth.tar
