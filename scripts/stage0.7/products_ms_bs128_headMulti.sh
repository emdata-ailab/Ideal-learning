...
CHECKPOINTS=log
R=.pth.tar
LOG_NAME=product_ms_bs128_headMulti
LOADER_TYPE=multi_repeat
HEAD_TYPE=multi
RESUME=/home/nfs/admin0/yaoguang/code/MetricLearning/Object-retrieval-others/log/Weight/product/checkpoints/product_ms_bs128_headMulti/model_best.pth.tar
