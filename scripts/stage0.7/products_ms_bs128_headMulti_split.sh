...
CHECKPOINTS=log
R=.pth.tar
LOG_NAME=product_ms_bs128_headMultiSplit
LOADER_TYPE=multi_repeat
HEAD_TYPE=multi_split
RESUME=/home/nfs/admin0/yaoguang/code/MetricLearning/Object-retrieval-others/log/Weight/product/checkpoints/product_ms_bs128_headMultiSplit/model_best.pth.tar
...
srun -N 1 --gres=gpu:1 -u --pty -p m40t4 python3 train.py --net ${NET} \
--data $DATA \
