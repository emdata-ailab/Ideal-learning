...
R=.pth.tar
LOG_NAME=car_triplet_bs128_headMultiSplit
...
# if [ ! -n "$1" ] ;then
echo "Begin Training!"
CUDA_VISIBLE_DEVICES=1 python3 /workspace/ideal/IDEAL-Object-retrieval-others/train.py --net ${NET} \
--data $DATA \
...
#srun -N 1 --gres=gpu:1 --pty
# bn_inception_weights_pt04.pt
#srun -N 1 --gres=gpu:1 --pty sh car_msloss.sh 
