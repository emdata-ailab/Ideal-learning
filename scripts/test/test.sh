...
#   --dim=512 --width=224 --batch_size=120 --data=car \
#   --data_root=/home/nfs/admin0/yaoguang/code/MetricLearning/Object-retrieval-others/DataSet \
#   --resume=/home/nfs/admin0/yaoguang/code/MetricLearning/Object-retrieval-others/log/Weight/car/checkpoints/car_ms_bs32_baseline \
#   --feature_path=/home/nfs/admin0/yaoguang/data/train_data/MetricLearning/features \
#   --testAllAngle=False --test_trans=center-crop \


python test_multiModel.py --net=BN-Inception \
--dim=512 --width=224 --batch_size=120 --data=car \
--data_root=/dataset/image_retrieval/ \
--resume=/workspace/ideal/IDEAL-Object-retrieval-others/log/Weight/car/checkpoints/train \
--feature_path=/workspace/ideal/IDEAL-Object-retrieval-others/MetricLearning/features \
--testAllAngle=False --test_trans=center-crop \